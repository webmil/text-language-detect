...
class TextLanguageDetectTest extends \PHPUnit_Framework_TestCase {
    ...
    {
        $method = new \ReflectionMethod('TextLanguageDetect', '_readdb');
        $method->setAccessible(true);
        $method->invoke(new TextLanguageDetect, 'thisfiledoesnotexist');
    }
    ...
    function test_readdbUnreadableFile()
    {
        ...
        $method = new \ReflectionMethod('TextLanguageDetect', '_readdb');
        $method->setAccessible(true);
        $method->invoke(new TextLanguageDetect, $name);
    }
    ...
    {
        $method = new \ReflectionMethod('TextLanguageDetect', '_checkTrigram');
        $method->setAccessible(TRUE);
        $method->invoke(new TextLanguageDetect, array());
    ...
    function test_checkTrigramNoArray()
    {
        $method = new \ReflectionMethod('TextLanguageDetect', '_checkTrigram');
        $method->setAccessible(TRUE);
        $method->invoke(new TextLanguageDetect, 'foo');
    }
    ...
    {
        $str = 'hello';
        $method = new \ReflectionMethod('\\TextLanguageDetect\\TextLanguageDetect', '_trigram');
        $method->setAccessible(TRUE);
        $method->invoke(new TextLanguageDetect, 'foo');

        $result = $method->invoke(new TextLanguageDetect, $str);
    ...
    function test_sort ()
    {
        ...
        $method = new \ReflectionMethod('\\TextLanguageDetect\\TextLanguageDetect', '_bub_sort');
        $method->setAccessible(TRUE);
        $method->invoke(new TextLanguageDetect, $arr);
    ...
    function testOmitLanguagesClearsClusterCache()
    {
        ...
        $this->assertAttributeEquals( NULL , '_clusters', $this->x);
        $this->x->clusterLanguages();
        $this->assertAttributeNotEquals( NULL , '_clusters', $this->x);
        $this->x->omitLanguages('german');
        $this->assertAttributeEquals( null , '_clusters', $this->x, 'cluster cache be empty now');
    }
//
